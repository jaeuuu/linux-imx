...
*/
	...
	rotary-encoder {
		...
		gpios = <&gpio3 21 GPIO_ACTIVE_LOW>, <&gpio3 22 GPIO_ACTIVE_LOW>;
		linux,axis = <0>;
		//rotary-encoder,steps = <24>;		/* for abs */
		rotary-encoder,steps-per-period = <1>;
		rotary-encoder,encoding = "gray";
		//rotary-encoder,rollover;			/* for abs */
		rotary-encoder,relative-axis;
		rotary-encoder,push-button;
		pb-gpios = <&gpio4 2 GPIO_ACTIVE_LOW>;
	};
};
...
&ecspi2 {
	...
	gpiom1: gpio@0 {
		 ...
		 * address is 4, So, mask is 0b00010000 (4th bit is to set).
...
&iomuxc {
	...
	pinctrl_hog: hoggrp {
		fsl,pins = <
			...
			/* CPLD IN, default pull-up state */
			//MX8MP_IOMUXC_SAI5_RXC__GPIO3_IO20		0x150

			/* jig board dip s/w pins */
			// MX8MP_IOMUXC_GPIO1_IO07__GPIO1_IO07		0X10
			MX8MP_IOMUXC_GPIO1_IO08__GPIO1_IO08		0x10
			// MX8MP_IOMUXC_GPIO1_IO13__GPIO1_IO13		0x10
			MX8MP_IOMUXC_SD1_CLK__GPIO2_IO00		0x10
			MX8MP_IOMUXC_SD1_CMD__GPIO2_IO01		0x10
			MX8MP_IOMUXC_SD1_DATA0__GPIO2_IO02		0x10
			MX8MP_IOMUXC_SD1_DATA1__GPIO2_IO03		0x10
			MX8MP_IOMUXC_SD1_DATA2__GPIO2_IO04		0x10
			MX8MP_IOMUXC_SD1_DATA3__GPIO2_IO05		0x10
			MX8MP_IOMUXC_SD1_DATA4__GPIO2_IO06		0x10
			MX8MP_IOMUXC_SD1_DATA5__GPIO2_IO07		0x10
			MX8MP_IOMUXC_SD1_DATA6__GPIO2_IO08		0x10
			MX8MP_IOMUXC_SD1_DATA7__GPIO2_IO09		0x10
			MX8MP_IOMUXC_SD1_RESET_B__GPIO2_IO10	0x10
			MX8MP_IOMUXC_SD2_WP__GPIO2_IO20			0x10
			MX8MP_IOMUXC_SAI1_RXFS__GPIO4_IO00		0x10
			MX8MP_IOMUXC_SAI1_TXD6__GPIO4_IO18		0x10
			MX8MP_IOMUXC_SAI1_TXD7__GPIO4_IO19		0x10A
